...
import { FiInstagram, FiGlobe, FiLinkedin, FiTwitter } from 'react-icons/fi'
import { Card } from '../../components/Card'

export function Home() {
    return (
      <div className='text-center mt-20 flex flex-col items-center justify-center h-screen'>
        ...
        <div className='mt-12 px-6 container max-w-screen-sm mx-auto space-y-4'>
          ...
          <Card uri='http://denmely.dev'><FiTwitter className='w-6 h-6 text-primary'/>Me siga no Twitter</Card>
